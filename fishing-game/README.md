...
Nach demselben Prinzip gibt's das **Zombie-Event**: ebenfalls einmal pro Minute Spielzeit geprüft, aber mit 5 % Wahrscheinlichkeit – also häufiger als das Alien-Event (1 %), aber immer noch selten. Dafür ist die Zombie-Mutation spürbar schwächer (+120 % statt +300 % Punkte, kein Glitzern). Beide Events laufen komplett unabhängig voneinander; sollten sie zufällig gleichzeitig aktiv sein, hat Alien Vorrang.
